...
class dcrateing extends StatefulWidget {

  @override
  _rateingState createState() => _rateingState();
}

class _rateingState extends State<dcrateing> {
  double rating1;
  String star;
  String emailid;
  String review;
            ...
            child: Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () async{
                        ...
                        await collectionReference.collection(consultdocid + "review").add(
                        {
                        'review':review,
                        ...
                        //add rating for avg
                        await collectionReference.collection('consultDoctors').doc(consultdocid).set(
                          {
                          'reviewadd': FieldValue.increment(rating1),
                          'reviewtotal': FieldValue.increment(1)
                          },
