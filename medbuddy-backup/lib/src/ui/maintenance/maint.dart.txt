...
class maint extends StatefulWidget {
  @override
    _maintState createState() => _maintState();
}

class _maintState extends State<maint> {
  bool dialogue;
 ...
 @override
  ...
  body: Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center,
      children: [
      Image.asset("assets/creatorspic/development2.png"),
      SizedBox(height: 10,),
