...
class rateingB extends StatefulWidget {

  @override
  _rateingState createState() => _rateingState();
}

class _rateingState extends State<rateingB> {
  double rating1;
  String star;
  String emailid;
  String review;
                    ...
                    onPressed: () async{
                      ...
                      textColor: Colors.white  
                       ...
                       String uname;
                        ...
                        await collectionReference.collection(Bdocid + "review").add(
                        {
                        'review':review,
                        ...
                        //add rating for avg
                        await collectionReference.collection('average rating').doc(Bdocid).set(
                          {
