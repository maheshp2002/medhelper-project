...
class rateingT extends StatefulWidget {

  @override
  _rateingState createState() => _rateingState();
}

class _rateingState extends State<rateingT> {
  double rating1;
  String star;
  String emailid;
  String review;
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () async{
                      ...
                      textColor: Colors.white  
                        ...
                        await collectionReference.collection(Tdocid + "review").add(
                        {
                        'review':review,
                        ...
                        //add rating for avg
                        await collectionReference.collection('average rating').doc(Tdocid).set(
                          {
