...
class Bratingdlt extends StatefulWidget {
  @override
  _sellerMapageState createState() => _sellerMapageState();
}

class _sellerMapageState extends State<Bratingdlt>{
                  ...
                  builder: (BuildContext context) {
                    ...
                    children: <Widget>[
                        ...
                        onTap: () async{
                          ...
                          await FirebaseFirestore.instance.collection('average rating').doc(Bdocid).set(
                          {
