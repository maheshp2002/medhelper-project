...
import 'package:medbuddy/src/ui/search/tags/syringeFull.dart';




class syringe extends StatefulWidget {
  @override
  _sellerMapageState createState() => _sellerMapageState();
}
var indexnosyringe;
String Sdocid;
class _sellerMapageState extends State<syringe>{
...
return Scaffold(
  appBar: AppBar(
	...
	body: 
  StreamBuilder(
      stream: FirebaseFirestore.instance.collection("Medicinesell").where('ID', isEqualTo: 'syringe').snapshots(),
          ...
          children: [
             GridView.builder(
                ...
                child: InkWell(
                  ...
                  onTap: (){
                      indexnosyringe = snapshot.data.docs[index];
                      Sdocid = snapshot.data.docs[index].id;
                      Navigator.push(context,
                      MaterialPageRoute(builder: (BuildContext context) => syringeFull()));
                  },
                  child: Column(
