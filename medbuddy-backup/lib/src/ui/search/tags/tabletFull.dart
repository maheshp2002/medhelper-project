...
import 'package:medbuddy/src/ui/rateing/rateingtag/Tdeleterating.dart';
...
class _DetailedItemState extends State<tabletFull> {
 List<String> images = [
  indexnotablet['images'],
  indexnotablet['images1'],
  indexnotablet['images2']
...
//gap btw borders
   ...
   StreamBuilder(
      stream:  FirebaseFirestore.instance.collection("Medicinesell").doc(Tdocid).snapshots(),
      builder: (context, snapshot) {
         if (!snapshot.hasData) {
          //hasdata = true;
          return Center
...
//button for fav  
          ...
          collectionCart.doc(Tdocid).set(
                        {
                          ...
                          'images1': indexnotablet['images1'],
                          'images2': indexnotablet['images2'],
                          'expire': indexnotablet['expire'],
  ...
  //button for review
            ...
            SizedBox(height: 30,), 
             ...
             InkWell(
          onTap: () async {
            Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Tratingdlt()));
