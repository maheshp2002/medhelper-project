...
class _DetailedItemState extends State<syringeFull> {
 List<String> images = [
  indexnosyringe['images'],
  indexnosyringe['images1'],
  indexnosyringe['images2']
...
//............................................................................................................ 
   ...
   StreamBuilder(
      stream:  FirebaseFirestore.instance.collection("average rating").doc(Sdocid).snapshots(),
...
//............................................................................................................
                  ...
                  child: BlinkText(indexnosyringe['discount %'] + "%",
...
//gap btw borders
   ...
   StreamBuilder(
      stream:  FirebaseFirestore.instance.collection("Medicinesell").doc(Sdocid).snapshots(),
      builder: (context, snapshot) {
         if (!snapshot.hasData) {
          //hasdata = true;
          return Center
...
//gap btw borders
    ...
    Card(
    child: ListTile(
    title:  Text("Actual price:" + " " + indexnosyringe['discount price']),
    )),
...
//     Card(
//     child: ListTile(              
//     title:  Text("Price:" + " " + indexnosyringe['price']),
//     )),
// //gap btw borders
//           const SizedBox(
//             height: 16,
...
//gap btw borders
 ...
 //button for navigator              
  ...
  //     //onPressed: ,
  //    onPressed: () { 
  //      FirebaseFirestore.instance.collection("Medicinesell").doc(Sdocid).update({
...
//button for fav  
          ...
          collectionCart.doc(Sdocid).set(
                        {
                          ...
                          'images1': indexnosyringe['images1'],
                          'images2': indexnosyringe['images2'],
                          'expire': indexnosyringe['expire'],
  ...
  //button for review
                                OutlineButton(
                                        onPressed: () async {
                             Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => rateingS()));
                                        },
                                        shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(
                                                MyDimens.double_4)),
            ...
            InkWell(
          onTap: () async {
            Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Sratingdlt()));
