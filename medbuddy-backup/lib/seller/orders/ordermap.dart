...
return Scaffold(
  appBar: AppBar(
	...
	body: 
  StreamBuilder(
      stream: FirebaseFirestore.instance.collection("ProductSeller").where('Did', isEqualTo: user.email).snapshots(),
             ...
             ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    child: ListTile(
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Updatestatus()));
                      },
                      leading: Image.network(snapshot.data.docs[index]['images']),
                      title: Text("Medicine name:" + " " + snapshot.data.docs[index]['medicine name']
                      + "\nPrice:" + " " + snapshot.data.docs[index]['price']
                      + "\ndosage:" + " " + snapshot.data.docs[index]['dosage']
                      ),
                      subtitle: Text("Coustomer name:" + " " + snapshot.data.docs[index]['name']),
                    ),
                    );
